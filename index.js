...
const articulos = [
...

  {
    ...
    resenaES: {
      ...
      caracteristicas:
        "La historia del Palacio comienza mucho antes de que se pusiera la primera piedra. Durante gran parte del siglo XIX, el Parlamento uruguayo funcionaba en el Cabildo de Montevideo, un edificio antiguo que con el tiempo quedó chico y en malas condiciones para una institución en crecimiento. En 1896, el Estado decidió por ley que se construiría un edificio nuevo en la Avenida Agraciada, frente a la Iglesia de la Aguada. Esa decisión fue el punto de partida de un proceso que duraría casi treinta años. En 1902 se llamó a un concurso internacional para elegir el diseño del edificio. La comisión a cargo fue presidida por el entonces senador José Batlle y Ordóñez, quien desde el principio fue uno de los más entusiastas con el proyecto. En 1904 llegaron 27 propuestas de distintas partes del mundo. El jurado no dio el primer premio a ninguna, pero eligió el proyecto llamado «Agraciada», del arquitecto ítalo-argentino Víctor Meano, que en ese momento estaba construyendo el Congreso de Argentina en Buenos Aires. Su diseño, de estilo neoclásico y con influencia del Parlamento de Viena, era el que mejor se ajustaba a lo que se buscaba. Sin embargo, Meano fue asesinado semanas después del veredicto y nunca llegó a saber que su proyecto había ganado. Las obras arrancaron en 1908, pero en 1913 el proyecto cambió de forma importante. El arquitecto italiano Gaetano Moretti fue contratado para terminar la construcción, que ya estaba bastante avanzada. Moretti era un profesional con mucha experiencia, muy conocido en el mundo de la arquitectura clásica. Su trabajo fue transformar lo que ya existía en algo aún más ambicioso, y los cambios que introdujo definieron el aspecto final del Palacio. Su colaborador uruguayo fue el arquitecto Eugenio Baroffio (1877–1956), quien después tuvo a su cargo el mantenimiento y cuidado del edificio durante años. El edificio tiene un estilo neoclásico con mucha influencia de la arquitectura griega antigua, algo que se nota sobre todo en las fachadas. Sus paredes, bóvedas y columnas están recubiertas de mármol, tanto uruguayo como italiano, lo que le da una imagen seria y sólida. Tiene tres naves grandes, varias salas, un piso superior con la biblioteca y algunos despachos, y un subsuelo amplio con oficinas y talleres. No es solo un edificio grande: es un edificio pensado para transmitir autoridad y permanencia. La ubicación del Palacio dentro de la ciudad tampoco fue un detalle menor. El diseño de las calles que lo rodean se inspiró en la Place de la Concorde de París: varias avenidas llegan directamente a la plaza del Palacio, y el edificio puede verse desde la Avenida 18 de Julio, la calle principal de Montevideo. Esa decisión hizo que el Palacio quedara como un punto de referencia visual en la ciudad, algo que se puede ver desde lejos y que orienta a quien camina por el centro. El espacio más conocido del interior es el Salón de los Pasos Perdidos, en la nave central, cubierto por una bóveda de piedra. En el centro del edificio se encuentra el Lucernario, una estructura cuadrada en altura que deja entrar luz natural al salón. Este elemento no estaba en el proyecto original de Meano: fue una idea de Moretti, que entendió que el edificio necesitaba una figura central en altura. El Lucernario está decorado con motivos griegos y tiene veinticuatro cariátides, figuras femeninas de casi cuatro metros, hechas por distintos escultores. Cada una representa un área del conocimiento humano: el derecho, la medicina, la música, la pintura, la agricultura, entre otras. La idea de rodear el espacio del poder legislativo con figuras que representan el saber no es casual: es un mensaje sobre qué debe sostener a las instituciones. Las salas de las cámaras de Senadores y Diputados tienen las paredes y los asientos de madera de nogal y caoba, materiales que duran siglos y que dan una imagen de seriedad. La biblioteca merece atención aparte: ocupa el segundo piso y tiene estanterías de caoba que llegan hasta el techo, un balcón interior, capiteles de bronce y un techo trabajado en madera. Está abierta a cualquier persona que quiera entrar, y guarda libros con mucho valor histórico. Es la segunda biblioteca más importante del país. El Palacio fue inaugurado el 25 de agosto de 1925, fecha elegida a propósito para coincidir con el centenario de la Declaratoria de la Independencia del Uruguay, y en 1975 fue declarado Monumento Histórico Nacional. Que un país pequeño y con pocos recursos haya dedicado casi tres décadas y mucho dinero a construir algo así dice mucho sobre lo que esa generación quería para el Uruguay. No se conformaron con algo funcional: quisieron algo que durara, que impresionara y que mostrara que las instituciones del país valían tanto como las de cualquier otro lugar del mundo.",
      importancia:
        "El Palacio fue inaugurado el 25 de agosto de 1925, fecha elegida a propósito para coincidir con el centenario de la Declaratoria de la Independencia del Uruguay, y en 1975 fue declarado Monumento Histórico Nacional. Que un país pequeño y con pocos recursos haya dedicado casi tres décadas y mucho dinero a construir algo así dice mucho sobre lo que esa generación quería para el Uruguay. No se conformaron con algo funcional: quisieron algo que durara, que impresionara y que mostrara que las instituciones del país valían tanto como las de cualquier otro lugar del mundo.",
      conclusion:
        "Hoy el Palacio sigue siendo la sede del Poder Legislativo y sigue abierto a todos. Las visitas guiadas son gratuitas, las sesiones de las cámaras son públicas y la biblioteca está disponible para cualquier ciudadano. Eso muestra que el edificio fue pensado no solo para los políticos, sino para la gente. Un siglo después de su inauguración, el Palacio Legislativo sigue siendo una prueba de que lo que se construye bien y con cuidado puede sobrevivir el paso del tiempo y seguir teniendo sentido.",
    },
